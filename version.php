...
$plugin->version = 2026092307; // Tope y visibilidad a los reintentos de red del ciclo con Epica
$plugin->release   = '1.20.2';      // Semver visible en el header del chat — bump en CADA cambio
