...
$plugin->version = 2026092500; // Ajusta epica_client al contrato real de local_awkepica
$plugin->release   = '1.20.3';      // Semver visible en el header del chat — bump en CADA cambio
