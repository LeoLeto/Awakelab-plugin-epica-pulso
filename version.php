...
$plugin->version = 2026092306; // Fixes revision Epica: texto literal, seccion 0, extraido_por, opcionales
$plugin->release   = '1.20.1';      // Semver visible en el header del chat — bump en CADA cambio
